...
#
THIRD=$(qsub $emailopts -N "3_$1"  -e $output_path -o $output_path -v name=$1,otu_method=$otu_method_in -W depend=afterok:$SECOND /share/apps/qiime_pipeline/pick_otus_open.sh)
echo $THIRD
#
